    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //{
                //    IFormFile poImgFile = Request.Form.Files["Avatar"];
                //    var binary = new BinaryReader(poImgFile.OpenReadStream());
                //    imageData = binary.ReadBytes((int)poImgFile.Length);     
                //}
                var user = new SnackisUser { UserName = Input.UserName, Email = Input.Email };
